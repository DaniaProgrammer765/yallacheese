...
export default function NormalPhotos() {
          ...
          {images.map((src, i) => (
            ...
            >
              ...
              <button
                ...
                className="relative -right-[5px] top-[5px] cursor-pointer hover:scale-110 transition-all duration-200"
                title="حذف الصورة"
              >
              ...
              <button
                ...
                className="mt-2 hover:scale-110 transition-all duration-200 cursor-pointer"
                title="تعديل الصورة"
              >
                <Image
                  src="/icons/edit.svg"
          ...
          {!showEffectsBar && !showSizesBar ? (
            <>
              ...
              >
                <div className="border border-[#F1F2F9] p-3 rounded-[16px] mb-2">
                  <Image
                    src="/icons/product2.svg"
                    alt="basket"
                    width={30}
                    height={30}
                  />
                </div>
                <span className="text-xs">إضافة للسلة</span>
              </button>
            </>
          ) : showEffectsBar ? (
            // ✅ شريط التأثيرات
