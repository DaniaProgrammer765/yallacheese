    ...
    <div className="flex flex-col gap-20 relative">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
         <div className="w-full md:w-1/2 order-1 md:order-2 flex justify-center mb-8 md:mb-0">
          <img src="/svg/step1.svg" alt="step 1" className="w-60 md:w-72" />
        </div>
        <div className="w-full md:w-1/2 order-2 md:order-1 text-right">
          <h4 className="text-xl text-primary font-bold mb-3">اختر نوع المنتج و الصور</h4>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        <div className="w-full md:w-1/2 order-2 md:order-1 text-right">
          <h4 className="text-xl text-primary font-bold mb-3">الدفع السريع</h4>
          <ul className="text-gray-600 space-y-2">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2 flex justify-center mb-8 md:mb-0">
          <img src="/svg/step3.svg" alt="step 3" className="w-60 md:w-72" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="max-w-7xl mx-auto px-6 hidden md:block">
    ...
    <div className="flex items-center justify-between gap-4 mb-6">
      <div className="w-1/5 overflow-hidden rounded-2xl">
        <img src="/images/photo1.png" alt="" className="w-full h-40 object-cover object-left-top" />
      </div>

      <div className="w-1/5 overflow-hidden rounded-2xl">
        <img src="/images/photo2.png" alt="" className="w-full h-40 object-cover object-center" />
      </div>

      <div className="w-1/5 flex items-center justify-center relative">
        {/* كلمة "كل" كبيرة */}
        <h3 className="text-6xl md:text-8xl font-extrabold text-primary pointer-events-none">كل</h3>
      </div>

      <div className="w-1/5 overflow-hidden rounded-2xl">
        <img src="/images/photo3.png" alt="" className="w-full h-40 object-cover object-center" />
      </div>

      <div className="w-1/5 overflow-hidden rounded-2xl"> 
        {/* -ml لتقطيع اليمين جزئياً */}
        <img src="/images/photo4.png" alt="" className="w-full h-40 object-cover object-right-top" />
      </div>
    </div>
    ...
    <div className="flex items-center justify-between gap-4 mb-6">
      <div className="overflow-hidden rounded-2xl w-44 h-40">
            <img src="/images/photo7.png" alt="" className="w-full h-full object-cover" />
          </div>
          <div>
        <h3 className=" md:text-7xl font-bold text-primary pointer-events-none">صورة</h3>
          </div>
      ...
      <div className="w-1/2 flex items-center justify-center relative">
        ...
        <div className="grid grid-cols-2 gap-4">
           <div className="overflow-hidden rounded-2xl ">
            <img src="/images/photo6.png" alt="" className="w-full h-full object-cover" />
          </div>
           <div className="w-full overflow-hidden rounded-2xl">
        <img src="/images/photo5.png" alt="" className="w-full h-40 object-cover object-right" />
      </div>
    ...
    <div className="flex items-center justify-between gap-4 mt-6">
      <div className="w-full overflow-hidden rounded-2xl">
        <img src="/images/photo8.png" alt="" className="w-full h-40 object-cover object-right" />
      </div>
        <h3 className="text-5xl md:text-7xl font-extrabold text-primary pointer-events-none">حكاية</h3>
      <div className="w-full overflow-hidden rounded-2xl">
        <img src="/images/photo9.png" alt="" className="w-full h-40 object-cover object-left" />
      </div>
        {/* كلمة "حكاية" كبيرة على اليسار */}
        {/* صف صغير من الصور وسط */}
        <div className="flex gap-3">
          <div className="overflow-hidden rounded-2xl w-36 h-40">
            <img src="/images/photo10.png" alt="" className="w-full h-full object-cover" />
          </div>
          <div className="overflow-hidden rounded-2xl w-36 h-40">
            <img src="/images/photo11.png" alt="" className="w-full h-full object-cover" />
          </div>
        </div>
    </div>
  </div>
  ...
  <div className="max-w-5xl mx-auto px-6">
    ...
    <div className="space-y-0">
      ...
      <details className="group shipping-qus-section border border-[#F1F2F9] hover:bg-pink-100 transition cursor-pointer">
        <summary className="flex justify-between items-center p-4 text-lg font-semibold headers">
          <div className="flex items-center gap-3">
            <img src="/icons/worldwide.svg" alt="worldwide icon" className="w-6 h-6" />
            <span>كم يستغرق الشحن؟</span>
          </div>
          <span className="text-primary group-open:rotate-180 transition-transform">⌃</span>
        </summary>
        <div className="px-12 pb-4 text-[#6F6C8F]">
          عملية الشحن تستغرق عادة من 3 إلى 5 أيام عمل، حسب المدينة وطريقة التوصيل.
        </div>
      </details>
      ...
      <details className="group bg-white border border-[#F1F2F9] hover:bg-gray-50 transition cursor-pointer">
        <summary className="flex justify-between items-center p-4 text-lg font-semibold headers">
          ...
          <span className="text-[#A0A3BD] group-open:rotate-180 transition-transform">⌃</span>
        </summary>
        <div className="px-12 pb-4 text-[#6F6C8F]">
          نعم، نقوم بالشحن إلى عدد من الدول عبر شركات شحن موثوقة برسوم إضافية بسيطة.
        </div>
      </details>
      ...
      <details className="group border border-[#F1F2F9] bg-white hover:bg-gray-50 transition cursor-pointer">
        <summary className="flex justify-between items-center p-4 text-lg font-semibold headers">
          <div className="flex items-center gap-3">
            <img src="/icons/user.svg" alt="return icon" className="w-6 h-6" />
            <span>هل يمكنني استرجاع الطلب؟</span>
          </div>
          <span className="text-[#A0A3BD] group-open:rotate-180 transition-transform">⌃</span>
        </summary>
        <div className="px-12 pb-4 text-[#6F6C8F]">
          يمكن استرجاع الطلب فقط في حال وجود خلل في الطباعة أو تلف أثناء الشحن.
        </div>
      </details>
    </div>
  </div>
...
<section className="relative py-10 flex justify-center bg-white">
  {/* المستطيل */}
  <div
    className="relative w-full max-w-5xl rounded-[45px] px-8 py-8 text-center text-white overflow-hidden ready-section"
  >
    <h2 className="text-[86px] font-bold">هل أنت مستعدّ؟</h2>
    <p className="mb-8 text-base max-w-2xl mx-auto">
      لقد أصبح مستعدًّا لتجاربك القادمة! مع YallaCheese، تحوّل صورك المميزة إلى لحظات لا تُنسى
    </p>
    <div className="mx-auto w-max cursor-pointer">
      <img src="/svg/yesbtn.svg" alt="نعم" className="transition hover:scale-105" />
    </div>
